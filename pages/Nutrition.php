...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Forever vous offre une gamme de compléments alimentaires unique pour prendre soin de vous au quotidien, ainsi que de ceux que vous aimez.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/Nutrition.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Nutrition - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/Nutrition.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="FOREVER vous offre une gamme de compléments alimentaires unique pour prendre soin de vous au quotidien, ainsi que de ceux que vous aimez." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Nutrition - Aloeprevention</title>
  </head>
  ...
  <p id="titre" style="text-align:center;">Nutrition</p> 
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 3");
...
?>
      ...
      <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Nutrition"><br>  
...
if($ligneCount == 3 || $ligneCount == 6 || $ligneCount == 9 || $ligneCount == 12 || $ligneCount == 15 || $ligneCount == 18 ) echo '</div><div class="row mx-auto">'; 
