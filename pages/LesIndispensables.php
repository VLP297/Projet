...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Retrouvez ici tous les produits d’hygiène et de soin FOREVER dont vous avez besoin au quotidien.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/LesIndispensables.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Les indispensables - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/LesIndispensables.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Retrouvez ici tous les produits d’hygiène et de soin FOREVER dont vous avez besoin au quotidien." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Les indispensables - Aloeprevention</title>
  </head>
  ...
  <body>
    ...
    <p id="titre" style="text-align:center;">Les indispensables</p> 
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE Id_Categorie LIKE 5");
...
?>
      ...
      <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Les Indispensables"><br>  
...
if($ligneCount == 3 || $ligneCount == 6 || $ligneCount == 9 ) echo '</div><div class="row mx-auto">'; 
