...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Détergent multi-usages ultra-concentré, très efficace pour décoller la saleté tenace, dissoudre les graisses et enlever les taches.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/Maison.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Maison - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/Maison.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Détergent multi-usages ultra-concentré, très efficace pour décoller la saleté tenace, dissoudre les graisses et enlever les taches." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Maison - Aloeprevention</title>
  </head>
  ...
  <p id="titre" style="text-align:center;">Maison</p><br>
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 10");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Maison"><br>  
