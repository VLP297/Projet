...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Forever Living Products est le fruit de la formidable réussite d'un homme : Rex Maughan et de sa volonté de créer une entreprise alliant bien-être et liberté financière.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/Entreprise.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="L'entreprise - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/Entreprise.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Forever Living Products est le fruit de la formidable réussite d'un homme : Rex Maughan et de sa volonté de créer une entreprise alliant bien-être et liberté financière." />
    <meta property="og:site_name" content="Aloeprevention" />
 
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>L'Entreprise - Aloeprevention</title>
  </head>
  ...
  <body>
    <div class="container-fluid bg-light">
	  <div class="row mx-auto text-justify">
        <div class="col-sm-7 mx-auto"><br>
          <hr><h1 id="titre">Une entreprise qui respecte la nature et les hommes</h1><hr><br>
          <img src="../images/L'entreprise/11" class="img-fluid rounded mx-auto">
		   <p id="txtproduits">La société Forever Living est engagée dans une démarche volontaire de progrès global à tous les niveaux de l'entreprise ce qui 
		   lui a permis d'obtenir la très convoitée certification QSE (Qualité, Santé, Environnement).</p>
        </div>
		<br>
		<div class="col-sm-12 mx-auto"><br>
			<div class="card mx-auto" style="max-width: 1200px;">
			 <div class="row no-gutters">
				<div class="col-sm-2">
				<img src="../images/L'entreprise/5.png" class="card-img" alt="140001">
				</div>
				<div class="col-10">
				<div class="card-body">
				<p id="txtproduits" class="card-text"><br>Certification qui garantit non seulement la maîtrise de l'impact de l'activité sur l'environnement mais aussi un engagement pour une amélioration constante de la performance environnementale.</p>
				</div>
				</div>
			 </div>
            </div>
        ...
        <div class="col-sm-12 mx-auto"><br>
			<div class="card mx-auto" style="max-width: 1200px;">
			 <div class="row no-gutters">
				<div class="col-10">
				<div class="card-body">
				<p id="txtproduits" class="card-text text-justify"><br>Certification qui garantit l'optimisation de la santé et de la sécurité au travail.
				L'objectif est d'obtenir une meilleure gestion des risques afin de réduire le nombre d'accidents, de se conformer à la législation et d'améliorer les performances.</p>
				</div>
				</div>
				<div class="col-sm-2">
				<img src="../images/L'entreprise/ohsas-18001.png" class="card-img" alt="18001">
				</div>
			 </div>
            </div>
		</div>
		<div class="col-sm-12 mx-auto"><br>
			<div class="card mx-auto" style="max-width: 1200px;">
			 <div class="row no-gutters">
				...
				<img src="../images/Accueil/labels/iso9001-100.png" class="card-img" alt="9001">
				</div>
				<div class="col-10">
				<div class="card-body">
				<p id="txtproduits" class="card-text">Certification qui garantit des produits d'une qualité constante qui répondent aux exigences des clients.</p>
				</div>
				</div>
			 </div>
            </div>
		...
		<div class="col-sm-12 mx-auto"><br>
			<div class="card mx-auto" style="max-width: 1200px;">
			 <div class="row no-gutters">
				<div class="col-11">
				<div class="card-body">
				<p id="txtproduits" class="card-text text-justify">Le label IASC reconnait notamment la pureté et la quantité d’Aloe vera contenus dans les produits ce qui est sécurisant alors que de nombreux fabricants 
				surfent sur l’engouement pour cette plante avec des produits qui contiennent un faible pourcentage d’Aloe vera ou utilisent de la poudre d’Aloe vera réhydratée 
				qui évidemment n’a pas les vertus du gel frais…</p>
				</div>
				</div>
				<div class="col-sm-1">
				<img src="../images/L'entreprise/9.jpg" class="card-img" alt="IASC">
				</div>
			 </div>
            </div>
	    </div>
	...
	<br>
      ...
      <div>      
        <img src="../images/Accueil/6/PanelProduits.png" class="img-fluid">
      </div>
