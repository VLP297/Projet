...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Vous avez des problèmes de peau sèche, déshydratée, terne ou dévitalisée, au sein de nos excellentes gammes Sonya, Infinite, Soins spécifiques et autres vous trouverez le produit adapté qu’il vous faut.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/Visage.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Visage - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/Visage.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Vous avez des problèmes de peau sèche, déshydratée, terne ou dévitalisée, au sein de nos excellentes gammes Sonya, Infinite, Soins spécifiques et autres vous trouverez le produit adapté qu’il vous faut." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Nous disposons de produits exceptionnels pour un visage resourcé - Aloeprevention</title>
  </head>
  ...
  <body>
    <br><br>
    <h1 id="titre" style="text-align:center;">Les soins visages exceptionnels Forever Living France</h1>
	<div class="container-fluid">
      <div class="row mx-auto">
		<div class="col-sm-6"><br><br><img src="../images/Produits/Sonya.png" class="img-fluid"></div>
	</div>
	</div>
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 6");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-2 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image"><br>  
...
if($ligneCount == 6) echo '</div><br><br><br><br><div class="row" mx-auto><div class="col-sm-6"><img src="../images/Produits/LesSoinsSpecifiques.png" class="img-fluid"></div></div><div class="row mx-auto">';
if ($ligneCount == 12) echo '</div><br><br><br><br><div class="row mx-auto"><div class="col-sm-6"><img src="../images/Produits/Infinite.png" class="img-fluid"></div></div><div class="row mx-auto">';
if($ligneCount == 17) echo '</div><br><br><br><br><div class="row"><div class="col-sm-6 mx-auto" id="titre">Les autres soins visage</div></div><div class="row mx-auto">';
if($ligneCount == 22) echo '</div><div class="row mx-auto">';
...
<br><br><p id="btncata">* Prix France Métropole TTC</p>
