...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Avec les produits de la gamme FOREVER, prenez soin de votre corps tout en douceur et relaxez-vous">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/CorpsEtCheveux.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Corps et cheveux - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/CorpsEtCheveux.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Avec les produits de la gamme FOREVER, prenez soin de votre corps tout en douceur et relaxez-vous" />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Corps et cheveux - Aloeprevention</title>
  </head>
    ...
    <!-- Début du body -->
    <body>
      <br><br><p id="titre" style="text-align:center;">Corps et cheveux</p><br>
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 7");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Corps Et Cheveux"><br>  
...
if($ligneCount == 3 || $ligneCount == 6) echo '</div><div class="row mx-auto">'; 
