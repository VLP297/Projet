...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Les bases du bien-être, Pulpes d’Aloe Vera et Miel, gorgés de précieux nutriments qui vous accompagneront jour après jour.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/LesBasesDuBienEtre.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Les bases du bien être - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/LesBasesDuBienEtre.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Les bases du bien-être, Pulpes d’Aloe Vera et Miel, gorgés de précieux nutriments qui vous accompagneront jour après jour." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Les bases du bien être - Aloeprevention</title>
  </head>
  ...
  <body>
	...
	<div class="container-fluid">
	  <div class="row mx-auto">
		...
		<hr><p id="titre">Pour un conseil personnalisé gratuit contactez moi <a style="color:green" target="_blanck"href="https://direct.foreverliving.fr/contact/330001049724/"><span class="navb">ici</span> !</a></p><hr><br>
		</div>
	  </div>
	</div>
    ...
    <div class="container-fluid">
      <div class="row mx-auto text-center">
        <div class="col-sm-6 mx-auto">
         <img src="../images/Accueil/1/aloereinvente.png" Alt="L'Aloe Vera Forever se réinvente" class="img-fluid rounded">
        </div>
        <div class="col-sm-6 mx-auto">
         <div id="carouselExampleIndicators5" class="carousel slide" data-interval="20000"  data-ride="false">
           <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../images/Accueil/2/PulpeNature.png" Alt="Pulpe Nature" class="img-fluid rounded">
             </div>
             <div class="carousel-item">
              <img src="../images/Accueil/2/PulpeBerry.png" Alt="Pulpe Berry" class="img-fluid rounded">
             </div>
             <div class="carousel-item">
              <img src="../images/Accueil/2/PulpePeaches.png" Alt="Pulpe Peaches" class="img-fluid rounded">  
             </div>
            </div>
	...
	<div class="container-fluid">
     <div class="row mx-auto">
	   <div class="col-sm-9 mx-auto"><p id="titre">Les bases du bien-être</p><br><br></div>
	 </div>
    </div>
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 1");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Les Bases du Bien Etre"><br>  
