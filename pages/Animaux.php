...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Découvrez le produit Formule Animale Ref. 30,  Cette solution aqueuse en spray particulièrement concentrée en Aloe Vera est le produit de soin idéal à appliquer sur vos animaux pour soulager leur problèmes au quotidien.">                                   
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/Animaux.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Animaux - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/Animaux.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Découvrez le produit Formule Animale Ref. 30,  Cette solution aqueuse en spray particulièrement concentrée en Aloe Vera est le produit de soin idéal à appliquer sur vos animaux pour soulager leur problèmes au quotidien." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Nous vous proposons une solution efficace pour vos Animaux - Aloeprevention</title>
  </head>
    ...
    <!-- Début du body -->
    <body>
      <br><br><h1 id="titre" style="text-align:center;">Découvrez notre formule<br>pour vos Animaux</h1><br>

     <div style="background-image: url('../images/Produits/Animaux.png'); background-repeat:no-repeat; background-size:cover;" class="container-fluid">
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 11");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Aloe First, Une solution efficace pour vos animaux"><br>  
