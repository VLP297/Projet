...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Fraîcheur, sensualité et beauté pour une journée parfaite.">
    <meta name="author" content="Aloeprevention">    
    <link rel="stylesheet" href="../styles/style.css">
    <link rel="canonical" href="https://www.aloeprevention.fr/pages/LesParfums.php">
    
    <!-- Open Graph meta pour Facebook -->
    <meta property="og:title" content="Les parfums - Aloeprevention" />
    <meta property="og:url" content="https://www.aloeprevention.fr/pages/LesParfums.php" />
    <meta property="og:image" content="https://www.aloeprevention.fr/images/Logo/Aloeprevention.png" />
    <meta property="og:description" content="Fraîcheur, sensualité et beauté pour une journée parfaite." />
    <meta property="og:site_name" content="Aloeprevention" />

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    <title>Les parfums - Aloeprevention</title>
  </head>
  ...
  <body>
    <br><br>
    <p id="titre" style="text-align:center;">Les parfums</p><br>
...
try{
    ...
    $resultat = $connexion->query("SELECT * FROM produits WHERE id_categorie LIKE 9");
...
?>
      ...
      <!-- Suite du body -->
       <div class="col-sm-3 mx-auto">
          <img src="<?php echo $ligne['URL']; ?>" class="img-fluid mx-auto d-block" alt="Responsive-image Les Parfums"><br>  
